...
public class HeroFacadeImpl implements  HeroFacade{
    ...
    public void deleteHero(HeroDTO hero) {
        heroService.deleteHero(beanMappingService.mapTo(hero, Hero.class));
    }
    ...
    public void deleteRole(HeroDTO hero, RoleDTO role) {
        heroService.deleteRole(beanMappingService.mapTo(hero, Hero.class),beanMappingService.mapTo(role, Role.class));
    }
