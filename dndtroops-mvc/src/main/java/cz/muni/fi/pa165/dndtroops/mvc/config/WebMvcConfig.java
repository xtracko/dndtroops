package cz.muni.fi.pa165.dndtroops.mvc.config;

import cz.muni.fi.pa165.dndtroops.sampledata.DndTroopsWithSampleDataConfiguration;
...
@EnableWebMvc
@Configuration
@Import({DndTroopsWithSampleDataConfiguration.class})
@ComponentScan(basePackages = "cz.muni.fi.pa165.dndtroops.mvc.controllers")
